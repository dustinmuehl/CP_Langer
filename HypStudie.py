...
def hypP(C, K, H, e):
    ...
    for h in range(len(H)):          #Für Hyperparameter HiddenLayer Größe
        ...
        for k in range(len(K)):          #für Hyperparamter Schrittweite und MB-Size
                ...
                for j in range(len(C)):      #um computerbedingte Laufzeitdifferenzen zu glätten, zb range(3)
...
C = [2, 5, 3, 7]      # Schrittweite
K = [10, 20, 30]        # Batch-Size
H = [30, 40, 50]    # Hidden-Layer Size
txt_weight(H)
